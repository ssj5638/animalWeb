		...
		<div class='frame_area'>
			...
			<div class='menu_graph_wrap'>
					...
					<div class="menubar">	
						<ul class="sidenav">
							<li>
								<a href="mainStatistic.jsp" target="display">Dashboard
								<span> 2018년 현재의 유기동물의 안락사, 자연사, 입양, 유기동물의 수 통계를 한눈에 볼 수 있는 페이지입니다. </span>
								</a>
							</li>
							<li>
								<a href="mainStatistics2.jsp" target="display">Statistic analysis
					...
					<div class="main_graph_area">
							<iframe id='iframes' name='display' src='mainStatistic.jsp'></iframe>	
					</div>
